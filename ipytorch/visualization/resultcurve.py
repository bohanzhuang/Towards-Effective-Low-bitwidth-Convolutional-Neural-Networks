...
class DrawWeightHistogram(object):
    def __init__(self, fig_folder):
        self.fig_folder = fig_folder
    
    def draw(self, weight, layer_name):
        n_bins = 100
        plt.figure()
        plt.hist(weight, bins=n_bins)
        plt.grid()
        title_str = "layer: {}".format(layer_name)
        plt.title(title_str)
        save_path = self.fig_folder + "layer_{}.png".format(layer_name)
