...
__all__ = ['QuanResNet', 'QuanBasicBlock', 'QuanBottleneck']
...
class QuanBasicBlock(nn.Module):
    expansion = 1

    def __init__(self, inplanes, planes, stride=1, downsample=None, is_last=False):
        super(QuanBasicBlock, self).__init__()
...
class QuanBottleneck(nn.Module):
    expansion = 4

    def __init__(self, inplanes, planes, stride=1, downsample=None, is_last=False):
        super(QuanBottleneck, self).__init__()
...
class QuanResNet(nn.Module):

    def __init__(self, depth, num_classes=1000):
        self.inplanes = 64
        super(QuanResNet, self).__init__()
        if depth < 50:
            block = QuanBasicBlock
        else:
            block = QuanBottleneck
